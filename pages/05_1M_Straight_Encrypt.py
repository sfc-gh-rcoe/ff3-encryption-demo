...
if wh_size != "NONE":
	...
	plain_text_table = os.environ["1m_plain_text_table"]
	...
	enc_matches_df = m_session1.sql("SELECT 'KEY678901' as keyname,\
									ff3_testing_db.ff3_testing_schema.encrypt_ff3_number_38_8_pass3('KEY678901', {}, $userkeys) as {}, \
									ff3_testing_db.ff3_testing_schema.encrypt_ff3_number_38_8_pass3('KEY678901', {}, $userkeys) as {}, \
									ff3_testing_db.ff3_testing_schema.encrypt_ff3_string_pass3('KEY678901', {}, $userkeys) as {} \
									FROM {}".format("ssn3", "ssn3", "phone", "phone", "email", "email", plain_text_table))
	...
	e_table_name = plain_text_table + "_{}_ENCRYPTED".format(t_start.strftime("%H_%M_%S"))
